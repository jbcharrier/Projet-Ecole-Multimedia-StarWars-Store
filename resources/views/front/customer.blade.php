    ...
    <div class="container">
        <form method="POST" action="{{url('customer')}}">
            ...
            <div class="form-text">
                ...
                <input class="input-text" id="number_card" name="number_card" type="text"
                       value="{{old('number_card')}}">
                @if($errors->has("")) <span class="error">{{$errors->first("")}}</span> @endif
            </div>
            <div class="form-text">
                <label class="label" for="nombre de commandes"></label>
                <input class="input-text" id="nombre de commandes" name="nombre de commandes" type="text"
                       value="{{old('nombre de commandes')}}">
                @if($errors->has("")) <span class="error">{{$errors->first("")}}</span> @endif
            </div>
